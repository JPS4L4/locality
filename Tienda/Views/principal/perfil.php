                    ...
                    <div class="col-md-4">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body text-center">
                                <img class="img-thumnail" src="<?php echo BASE_URL . 'assets/images/carrito.png'; ?>" alt="" width="150">
                                <hr>
...
<!-- Fin del bloque del perfil -->

<!-- Inicio estado del pedido -->
<div id="modalPedido" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="">
