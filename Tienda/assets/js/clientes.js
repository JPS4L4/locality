...
function botonPaypal(total) {
    paypal.Buttons({
        // Configura la transacción cuando se hace clic en el botón de pago
        createOrder: (data, actions) => {
          return actions.order.create({
            purchase_units: [{
              amount: {
                value: total // También se puede hacer referencia a una variable o función
              }
            }]
          });
        },
        // Finaliza la transacción después de la aprobación del pago
...
// Agregar calificación a un producto
